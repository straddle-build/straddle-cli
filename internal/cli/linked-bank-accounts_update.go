...
func newLinkedBankAccountsUpdateCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		Annotations: map[string]string{"straddle:endpoint": "linked-bank-accounts.update", "straddle:operation-id": "updateLinkedBankAccount", "straddle:method": "PUT", "straddle:path": "/v1/linked_bank_accounts/{linked_bank_account_id}"},
