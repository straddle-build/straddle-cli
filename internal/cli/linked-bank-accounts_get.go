...
func init() {
	registerGeneratedEndpoint("linked-bank-accounts.get", newLinkedBankAccountsGetCmd)
	registerSurface(surface.Surface{
		Endpoint:    "linked-bank-accounts.get",
...
func newLinkedBankAccountsGetCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		Short:   "Get a linked bank account",
		Example: "  straddle linked-bank-accounts get <linked_bank_account_id>",
		Annotations: map[string]string{
			"straddle:endpoint":     "linked-bank-accounts.get",
			"straddle:operation-id": "getLinkedBankAccount",
			"straddle:method":       "GET",
	...
	applyOverlay("linked-bank-accounts.get", cmd)
	return cmd
}
