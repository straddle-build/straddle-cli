...
func init() {
	registerGeneratedEndpoint("charges.hold", newChargesHoldGeneratedCmd)
	registerSurface(surface.Surface{
		Endpoint:    "charges.hold",
...
func newChargesHoldGeneratedCmd(flags *rootFlags) *cobra.Command {
	s := surface.Surface{
		Endpoint:    "charges.hold",
		OperationID: "holdCharge",
		Method:      "PUT",
	...
	cmd := &cobra.Command{
		Use:     "hold <id>",
		Short:   "Hold a charge",
		Example: "  straddle charges hold <id>",
		Annotations: map[string]string{
			"straddle:endpoint":     "charges.hold",
			"straddle:operation-id": "holdCharge",
			"straddle:method":       "PUT",
			"straddle:path":         "/v1/charges/{id}/hold",
		},
	}
