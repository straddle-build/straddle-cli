...
func newAccountsUpdateCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		Annotations: map[string]string{"straddle:endpoint": "accounts.update", "straddle:operation-id": "updateAccount", "straddle:method": "PUT", "straddle:path": "/v1/accounts/{account_id}"},
