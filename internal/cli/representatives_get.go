...
func newRepresentativesGetCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		Annotations: map[string]string{"straddle:endpoint": "representatives.get", "straddle:operation-id": "getRepresentative", "straddle:method": "GET", "straddle:path": "/v1/representatives/{representative_id}", "mcp:read-only": "true"},
