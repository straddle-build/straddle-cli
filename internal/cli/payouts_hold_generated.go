...
func init() {
	registerGeneratedEndpoint("payouts.hold", newPayoutsHoldGeneratedCmd)
	registerSurface(surface.Surface{
		Endpoint:    "payouts.hold",
...
func newPayoutsHoldGeneratedCmd(flags *rootFlags) *cobra.Command {
	s := surface.Surface{
		Endpoint:    "payouts.hold",
		OperationID: "holdPayout",
		Method:      "PUT",
	...
	cmd := &cobra.Command{
		Use:     "hold <id>",
		Short:   "Hold a payout",
		Example: "  straddle payouts hold <id>",
		Annotations: map[string]string{
			"straddle:endpoint":     "payouts.hold",
			"straddle:operation-id": "holdPayout",
			"straddle:method":       "PUT",
			"straddle:path":         "/v1/payouts/{id}/hold",
		},
	}
