...
func init() {
	registerGeneratedEndpoint("representatives.create", newRepresentativesCreateCmd)
	registerSurface(surface.Surface{
		Endpoint:    "representatives.create",
		...
		Flags: []surface.Flag{
			...
			},
			{
				...
				Kind:        surface.KindString,
				Required:    true,
				Description: "ID of the account associated with the representative.",
				Format:      "uuid",
			},
			{
				Name:        "dob",
			...
			},
			{
				...
				Kind:        surface.KindString,
				Required:    true,
				Description: "Representative's company email address.",
				Format:      "email",
			},
			{
				Name:        "external-id",
...
func newRepresentativesCreateCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		Use:     "create",
		Short:   "Create a representative",
		Example: "  straddle representatives create",
		Annotations: map[string]string{
			"straddle:endpoint":     "representatives.create",
			"straddle:operation-id": "createRepresentative",
	...
	applyOverlay("representatives.create", cmd)
	return cmd
}
