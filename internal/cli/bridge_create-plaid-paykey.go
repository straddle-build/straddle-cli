...
func init() {
	registerGeneratedEndpoint("bridge.create-plaid-paykey", newBridgeCreatePlaidPaykeyCmd)
	registerSurface(surface.Surface{
		Endpoint:    "bridge.create-plaid-paykey",
...
func newBridgeCreatePlaidPaykeyCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		Short:   "Create a paykey from a Plaid token",
		Example: "  straddle bridge create-plaid-paykey",
		Annotations: map[string]string{
			"straddle:endpoint":     "bridge.create-plaid-paykey",
			"straddle:operation-id": "createPlaidPaykey",
			"straddle:method":       "POST",
			"straddle:path":         "/v1/bridge/plaid",
		},
	}
	...
	applyOverlay("bridge.create-plaid-paykey", cmd)
	return cmd
}
