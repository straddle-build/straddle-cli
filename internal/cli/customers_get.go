...
func init() {
	registerGeneratedEndpoint("customers.get", newCustomersGetCmd)
...
func newCustomersGetCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		Example: "  straddle customers get <id>",
		Annotations: map[string]string{
			"straddle:endpoint":     "customers.get",
			"straddle:operation-id": "getCustomer",
			"straddle:method":       "GET",
	...
	applyOverlay("customers.get", cmd)
	return cmd
}
