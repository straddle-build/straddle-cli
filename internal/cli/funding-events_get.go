...
func newFundingEventsGetCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		Annotations: map[string]string{"straddle:endpoint": "funding-events.get", "straddle:operation-id": "getFundingEvent", "straddle:method": "GET", "straddle:path": "/v1/funding_events/{id}", "mcp:read-only": "true"},
