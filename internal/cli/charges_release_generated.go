...
func init() {
	registerGeneratedEndpoint("charges.release", newChargesReleaseGeneratedCmd)
	registerSurface(surface.Surface{
		Endpoint:    "charges.release",
...
func newChargesReleaseGeneratedCmd(flags *rootFlags) *cobra.Command {
	s := surface.Surface{
		Endpoint:    "charges.release",
		OperationID: "releaseCharge",
		Method:      "PUT",
	...
	cmd := &cobra.Command{
		Use:     "release <id>",
		Short:   "Release a charge",
		Example: "  straddle charges release <id>",
		Annotations: map[string]string{
			"straddle:endpoint":     "charges.release",
			"straddle:operation-id": "releaseCharge",
			"straddle:method":       "PUT",
	...
	applyOverlay("charges.release", cmd)
	return cmd
}
